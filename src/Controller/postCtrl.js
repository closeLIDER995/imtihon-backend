...
const postCtrl = {
    ...
    getAllPosts: async (req, res) => {
        try {
            ...
            const me = await User.findById(myId).select("followed");
            ...
            if (!allPostsRaw || allPostsRaw.length === 0) {
            ...
            const allPosts = addLikeCount(allPostsRaw).sort((a, b) => b.likesCount - a.likesCount);
